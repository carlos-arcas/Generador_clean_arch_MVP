"""Regla que evita imports desde dominio hacia infraestructura."""
...
class ReglaAplicacionNoDependeInfraestructura(ReglaDependencia):
    """Valida import prohibido de infraestructura dentro de dominio."""
