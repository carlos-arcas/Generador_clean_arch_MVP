"""Composition root único de la aplicación.

Este módulo centraliza el ensamblado de adaptadores concretos de infraestructura
con los casos de uso de aplicación.
"""
...
class ContenedorAplicacion:
    """Dependencias ensambladas y listas para usar en presentación."""
...
def construir_contenedor_aplicacion() -> ContenedorAplicacion:
    """Construye y devuelve el contenedor de casos de uso de la aplicación."""
